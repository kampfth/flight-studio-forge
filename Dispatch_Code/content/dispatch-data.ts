 ...
 * 
 * Responsibility: Dados de exemplo e funções utilitárias para Dispatch
 * 
 * Usage:
 * ```tsx
 * import { dispatchPosts, getDispatchBySlug, getAllDispatchTags } from '@/content/dispatch';
 * ```
 */
...
// =============================================================================
// DADOS DE EXEMPLO
// Substitua por dados do seu CMS ou API
// =============================================================================
 ...
 * @returns O post encontrado ou undefined
 */
...
/**
 * Busca todos os posts relacionados a um produto
...
/**
 * Busca todos os posts com uma tag específica
...
/**
 * Obtém todas as tags únicas de todos os posts
 * @returns Array de tags ordenadas alfabeticamente
 */
